...
My name is Justin Piesco, and this is a summarized of my work as a Content Manager and Technical Writer for Microsoft.
...
- [Use the WinForms ReportViewer control](https://learn.microsoft.com/en-us/sql/reporting-services/application-integration/using-the-winforms-reportviewer-control)
  - Improved Acrolinx score from 82% correctness to 96% correctness.
- [Integrate Reporting Services by using SOAP - Windows application](https://learn.microsoft.com/en-us/sql/reporting-services/application-integration/integrating-reporting-services-using-soap-windows-application)
...
- [Build reliable and secure C++ programs](https://learn.microsoft.com/en-us/cpp/code-quality/build-reliable-secure-programs)
- [Messaging Bridge pattern](https://learn.microsoft.com/en-us/azure/architecture/patterns/messaging-bridge)
- [AD FS Extranet Lockout and Extranet Smart Lockout Overview](https://learn.microsoft.com/en-us/windows-server/identity/ad-fs/operations/configure-ad-fs-extranet-smart-lockout-protection)
...
- [Use ExecutionLog and the ExecutionLog3 view in Reporting Services](https://learn.microsoft.com/en-us/sql/reporting-services/report-server/report-server-executionlog-and-the-executionlog3-view)
- [Set time-out values for report and shared dataset processing in Reporting Services](https://learn.microsoft.com/en-us/sql/reporting-services/report-server/setting-time-out-values-for-report-and-shared-dataset-processing-ssrs)
- [Troubleshoot Reporting Services subscriptions and delivery](https://learn.microsoft.com/en-us/sql/reporting-services/troubleshooting/troubleshoot-reporting-services-subscriptions-and-delivery)
...
- [Walkthrough: Mapping Properties Using the ElementHost Control](https://learn.microsoft.com/en-us/dotnet/desktop/wpf/advanced/walkthrough-mapping-properties-using-the-elementhost-control)
- [Walkthrough: Mapping Properties Using the WindowsFormsHost Element](https://learn.microsoft.com/en-us/dotnet/desktop/wpf/advanced/walkthrough-mapping-properties-using-the-windowsformshost-element)
- [Windows Forms and WPF Property Mapping](https://learn.microsoft.com/en-us/dotnet/desktop/wpf/advanced/windows-forms-and-wpf-property-mapping)
